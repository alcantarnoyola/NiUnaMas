...
public class ServicioContactos extends AsyncTask<String, Integer, JSONObject> {

    private TCP tcp;
    private ServicioContactos.IServicioContactos delegate;
    private int error;
    ...
    public ServicioContactos(ServicioContactos.IServicioContactos ctx) {
        ...
        String getParametros = "device="+singelton.deviceId+"&nombre="+singelton.nombreContacto+"&numero="+singelton.numeroContacto+"&accion="+singelton.selectOper;
        String url="https://www.solucionesonline.mx/apps_moviles/monitoreoNum/storedProcedure/spContactos.php";
    ...
    public interface IServicioContactos {
         ...
         * @param response
         */
        void servicioContactosFinished(int error, String response);
    }
    ...
    protected void onPostExecute(JSONObject result) {
        try {
            if (delegate != null) {
                ...
                delegate.servicioContactosFinished(error, response);
            }
        }catch (Exception e){
            e.printStackTrace();
            error = ERROR_COMM;
